...
func updateInstructions() string {
	...
	case "linux":
		return "  brew update && brew upgrade engram\n  or: go install github.com/castrometro/engram/cmd/engram@latest"
	default:
		return "  go install github.com/castrometro/engram/cmd/engram@latest\n  or: https://github.com/castrometro/engram/releases/latest"
	}
}
